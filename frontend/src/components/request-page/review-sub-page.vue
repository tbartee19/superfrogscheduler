<template>
  <div>
    <span class="date">
      <div class="title">REVIEW REQUEST</div>
      <table>
        <tr>
          <td>Date</td>
    ...
    <span class="event-info-1">
      ...
      <table>
        ...
        <tr>
          <td>Expenses/Benefits</td>
          <td>{{eventInfo.expensesBenefits}}</td>
        </tr>
      </table>
    </span>
    <span class="cost-1">
      ...
      <table>
        <tr>
          <td>${{getTotalPrice(eventInfo.startTime,eventInfo.endTime, eventInfo.eventType)}}</td>
        </tr>
      </table>
    </span>
  </div>
